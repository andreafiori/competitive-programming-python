...
class ConvergentsOfE:
    ...
    def sum_digits(self, num: int) -> int:
        ...
        >>> ConvergentsOfE().sum_digits(1)
        1
        >>> ConvergentsOfE().sum_digits(12345)
        15
        >>> ConvergentsOfE().sum_digits(999001)
        28
        """
        digit_sum = 0
        while num > 0:
    ...
    def solution(self, max_n: int = 100) -> int:
        """
        ...
        return self.sum_digits(cur_numerator)
