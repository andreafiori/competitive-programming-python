...
class PandigitalPrime:
    ...
    def is_prime(self, number: int) -> bool:
        ...
        >>> PandigitalPrime().is_prime(0)
        False
        >>> PandigitalPrime().is_prime(1)
        False
        >>> PandigitalPrime().is_prime(2)
        True
        >>> PandigitalPrime().is_prime(3)
        True
        >>> PandigitalPrime().is_prime(27)
        False
        >>> PandigitalPrime().is_prime(87)
        False
        >>> PandigitalPrime().is_prime(563)
        True
        >>> PandigitalPrime().is_prime(2999)
        True
        >>> PandigitalPrime().is_prime(67483)
        False
        """
