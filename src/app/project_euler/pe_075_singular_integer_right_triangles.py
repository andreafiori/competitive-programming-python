...
class SingularIntegerRightTriangles:
    ...
    def solution(self, limit: int = 1500000) -> int:
        """
        ...
        >>> SingularIntegerRightTriangles().solution(50)
        6
        >>> SingularIntegerRightTriangles().solution(1000)
        112
        >>> SingularIntegerRightTriangles().solution(50000)
        5502
        """
