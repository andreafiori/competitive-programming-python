"""
Project Euler 686 | https://projecteuler.net/problem=686
...
class PowersOftwo:
    ...
    def log_difference(self, n: int) -> float:
        """
        ...
        log_number = math.log(2, 10) * n
        difference = round((log_number - int(log_number)), 15)

        return difference


    def solution(self, n: int = 678910) -> int:
        """
        ...
        while position < n:
            difference = self.log_difference(power_iterator)
