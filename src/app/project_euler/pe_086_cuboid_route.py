...
Solution:
    ...
    In the code below, d is sum_shortest_sides and M is max_cuboid_size.
...
class CuboidRoute:
    ...
    def solution(self, limit: int = 1000000) -> int:
        """
        ...
        >>> CuboidRoute().solution(100)
        24
        >>> CuboidRoute().solution(1000)
        72
        >>> CuboidRoute().solution(2000)
        100
        >>> CuboidRoute().solution(20000)
        288
        """
        num_cuboids: int = 0
