"""
Problem 092: Square digit chains | https://projecteuler.net/problem=92
...
class SquareDigitChains:
    ...
    def next_number(self, number: int) -> int:
        """
        ...
        while number:
            ...
            sum_of_digits_squared += self.DIGITS_SQUARED[number % 100000]
            number //= 100000
