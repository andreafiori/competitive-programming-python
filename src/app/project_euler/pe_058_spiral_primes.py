...
class SpiralPrimes:
    ...
    def is_prime(self, number: int) -> bool:
        ...
        >>> SpiralPrimes().is_prime(0)
        False
        >>> SpiralPrimes().is_prime(1)
        False
        >>> SpiralPrimes().is_prime(2)
        True
        >>> SpiralPrimes().is_prime(3)
        True
        >>> SpiralPrimes().is_prime(27)
        False
        >>> SpiralPrimes().is_prime(87)
        False
        >>> SpiralPrimes().is_prime(563)
        True
        >>> SpiralPrimes().is_prime(2999)
        True
        >>> SpiralPrimes().is_prime(67483)
        False
        """
    ...
    def solution(self,ratio: float = 0.1) -> int:
        """
