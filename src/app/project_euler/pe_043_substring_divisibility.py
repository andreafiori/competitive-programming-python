...
class SubStringDivisibility:
    ...
    def is_substring_divisible(self, num: tuple) -> bool:
        ...
        >>> SubStringDivisibility().is_substring_divisible((0, 1, 2, 4, 6, 5, 7, 3, 8, 9))
        False
        >>> SubStringDivisibility().is_substring_divisible((5, 1, 2, 4, 6, 0, 7, 8, 3, 9))
        False
        >>> SubStringDivisibility().is_substring_divisible((1, 4, 0, 6, 3, 5, 7, 2, 8, 9))
        True
        """
        if num[3] % 2 != 0:
            return False
