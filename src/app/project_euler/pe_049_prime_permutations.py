...
class PrimePermutation:
    ...
    def is_prime(self, number: int) -> bool:
        ...
        >>> PrimePermutation().is_prime(0)
        False
        >>> PrimePermutation().is_prime(1)
        False
        >>> PrimePermutation().is_prime(2)
        True
        >>> PrimePermutation().is_prime(3)
        True
        >>> PrimePermutation().is_prime(27)
        False
        >>> PrimePermutation().is_prime(87)
        False
        >>> PrimePermutation().is_prime(563)
        True
        >>> PrimePermutation().is_prime(2999)
        True
        >>> PrimePermutation().is_prime(67483)
        False
        """
    ...
    def search(self, target: int, prime_list: list) -> bool:
        """
        function to search a number in a list using Binary Search.
        >>> PrimePermutation().search(3, [1, 2, 3])
        True
        >>> PrimePermutation().search(4, [1, 2, 3])
        False
        >>> PrimePermutation().search(101, list(range(-100, 100)))
        False
        """
    ...
    def solution(self):
        ...
        296962999629
        """
        prime_list = [n for n in range(1001, 10000, 2) if self.is_prime(n)]
        candidates = []
        ...
        for number in prime_list:
            ...
            for prime_member in permutations(list(str(number))):
                ...
                if PrimePermutation().search(prime, prime_list):
