"""
Problem 85: Rectangular Grid | https://projecteuler.net/problem=85
...
Reference: https://en.wikipedia.org/wiki/Triangular_number | https://en.wikipedia.org/wiki/Quadratic_formula
...
class RectangularGrid:
    ...
    def solution(self, target: int = 2000000) -> int:
        """
        Find the area of the grid which contains as close to two million rectangles
        as possible.
        >>> RectangularGrid().solution(20)
        6
        >>> RectangularGrid().solution(2000)
        72
        >>> RectangularGrid().solution(2000000000)
        86595
        """
