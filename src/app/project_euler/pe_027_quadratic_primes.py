...
class QuadraticPrimes:
    ...
    def is_prime(self, number: int) -> bool:
        ...
        >>> QuadraticPrimes().is_prime(2)
        True
        >>> QuadraticPrimes().is_prime(3)
        True
        >>> QuadraticPrimes().is_prime(27)
        False
        >>> QuadraticPrimes().is_prime(2999)
        True
        >>> QuadraticPrimes().is_prime(0)
        False
        >>> QuadraticPrimes().is_prime(1)
        False
        >>> QuadraticPrimes().is_prime(-10)
        False
        """
    ...
    def solution(self, a_limit: int = 1000, b_limit: int = 1000) -> int:
        """
        >>> solution(1000, 1000)
        -59231
        >>> solution(200, 1000)
