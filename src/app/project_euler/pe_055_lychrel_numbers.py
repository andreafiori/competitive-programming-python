...
class LyrichelNumber:

    def is_palindrome(self, n: int) -> bool:
        """
        Returns True if a number is palindrome.
        >>> LyrichelNumber().is_palindrome(12567321)
        False
        >>> LyrichelNumber().is_palindrome(1221)
        True
        >>> LyrichelNumber().is_palindrome(9876789)
        True
        """
        return str(n) == str(n)[::-1]


    def sum_reverse(self, n: int) -> int:
        """
        Returns the sum of n and reverse of n.
        >>> LyrichelNumber().sum_reverse(123)
        444
        >>> LyrichelNumber().sum_reverse(3478)
        12221
        >>> LyrichelNumber().sum_reverse(12)
        33
        """
        return int(n) + int(str(n)[::-1])


    def solution(self, limit: int = 10000) -> int:
        """
        Returns the count of all lychrel numbers below limit.
        >>> LyrichelNumber().solution(10000)
        249
        >>> LyrichelNumber().solution(5000)
        76
        >>> LyrichelNumber().solution(1000)
        13
        """
        lychrel_nums = []
